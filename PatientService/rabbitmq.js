...
const listenForMessages = async () => {
	...
	await channel.assertQueue('patient-service-queue');
	await channel.bindQueue('patient-service-queue', 'key-distribution', '');
	channel.consume('patient-service-queue', async (msg) => {
		if(msg.content){
